package com.dss.auditlog.user;

import com.dss.auditlog.AuditLogApplication;
import com.dss.auditlog.entity.User;
import com.dss.auditlog.view.user.UserDetailView;
import com.dss.auditlog.view.user.UserListView;
 ...
 */
@UiTest
@SpringBootTest(classes = {AuditLogApplication.class, FlowuiTestAssistConfiguration.class})
